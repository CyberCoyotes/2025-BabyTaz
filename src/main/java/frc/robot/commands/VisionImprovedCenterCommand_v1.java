...
public class VisionImprovedCenterCommand_v1 extends Command {
    ...
    public VisionImprovedCenterCommand_v1(VisionSubsystem vision, CommandSwerveDrivetrain drivetrain) {
        this.vision = vision;
    ...
    public void execute() {
        ...
        // Calculate smooth motion profiles
